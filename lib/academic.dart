                      ...
                      TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          enabledBorder: UnderlineInputBorder(
                            borderSide: BorderSide(color: Color(0xFFFFACA9)),
                          ),
                      ...
                      Container(
                        ...
                        child: DropdownButtonHideUnderline(
                          child: DropdownButton<String>(
                            ...
                            iconSize: 30,
                            elevation: 0,
                            style: TextStyle(color: Color(0XFFFF6D5D), fontSize: 25),
                            onChanged: (String newValue) {
                              /*   setState(() {
                                dropdownValue = newValue;
                              });*/
                            },
                            items: <String>['Maths', 'Programming', 'Electrical', 'Microprocessor']
